...
export class AuthService {
  ...
  register(command: RegisterCommandModel): Observable<UserItemModel> {
    ...
    return this.httpClient.post<UserItemModel>(`${this.BASE_URL}/register`, command);
  }
  ...
  login(command: LoginCommandModel): Observable<AuthResponseModel> {
    ...
    return this.httpClient.post<AuthResponseModel>(`${this.BASE_URL}/login`, command).pipe(
      tap(response => {
